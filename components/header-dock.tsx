...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/adhaghani",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/adhaghani/",
        icon: Icons.linkedin,
      },
      email: {
        name: "Send Email",
...
export function DockDemo() {
  return (
    <div className="flex flex-col items-center pointer-events-none justify-center w-full max-w-screen-xl mx-auto px-4 overflow-hidden">
      <TooltipProvider delayDuration={0}>
        <Dock direction="middle" className="max-w-full !pointer-events-auto">
